...
public class PaymentController {
    ...
    @Autowired
    private com.course.platform.mapper.UserMapper userMapper;

    @Autowired
    private com.course.platform.mapper.PaymentOrderMapper paymentOrderMapper;

    @Autowired
    private com.course.platform.mapper.OperationLogMapper operationLogMapper;
