...
const orderNo = field('orderNo', '订单编号', 'ORD1234567890');
...
export const externalEndpoints = [
  ...
  { id: 'queryProgress', path: 'query-progress', title: '查询订单进度', scope: 'orders:read',
    description: '按订单编号读取已同步的进度，仅可查询自己的订单；查询不会重复发起任务。',
    fields: [orderNo],
...
export const externalErrorCodes = [
  ...
  { http: '400 / 502', code: '-1 / -503', message: '业务处理失败', solution: '保存 message 与 errorId，联系管理员排查；勿重复下单' },
];
